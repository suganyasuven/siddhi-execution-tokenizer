...
public class TestCaseOfTokenizerStreamProcessor {
    private static final Logger LOGGER = Logger.getLogger(TestCaseOfTokenizerStreamProcessor.class);
